...
{
  if(Xpos <  hltdc.LayerCfg[ActiveLayer].WindowX0) return;
  if(Ypos <  hltdc.LayerCfg[ActiveLayer].WindowY0) return;
  if(Xpos >= hltdc.LayerCfg[ActiveLayer].WindowX1) return;
  if(Ypos >= hltdc.LayerCfg[ActiveLayer].WindowY1) return;
